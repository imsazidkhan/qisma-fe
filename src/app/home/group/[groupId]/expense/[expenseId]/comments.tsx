...
import { ExpenseCommentsScreen } from '@/features/expenses/screens/ExpenseCommentsScreen';
...
export default function GroupExpenseCommentsRoute(): ReactElement {
  ...
  return <ExpenseCommentsScreen expenseId={expenseId} groupId={groupId} onBack={onBack} />;
}
