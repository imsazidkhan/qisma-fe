...
import { GroupBalanceScreen } from '@/features/groups/screens/GroupBalanceScreen';
...
/**
 * Per-member settlement edges + viewer net summary (`GET /v1/groups/:groupId/balances`).
 */
export default function HomeGroupBalancesRoute(): ReactElement {
  ...
  return <GroupBalanceScreen groupId={groupId} onBack={onBack} />;
}
